...
export default function Loginform() {
    ...
    return (
        <div>
            ...
            {
                err && (
                    <div className="mb-4 p-4 rounded bg-red-50 text-red-800 border border-red-100">
                        {err}
                    </div>
                )
            }
            ...
            <form onSubmit={handleSubmit} noValidate>
                <div className="mb-4  flex flex-col gap-4 ">
                    ...
                    <input
                        ...
                        className={`w-full rounded-md border px-3 py-2 focus:outline-none focus:ring ${touched.email && !emailIsValid
                    ...
                    <div className="mb-4">
                        ...
                        <input
                            ...
                            className={`w-full rounded-md border px-3 py-2 focus:outline-none focus:ring ${touched.password && !passwordIsValid
                                    ? "border-red-400 focus:ring-red-200"
                                    : "border-gray-200 focus:ring-indigo-200"
                                }`}
                    ...
                    <div className="text-sm text-gray-600 underline">
                        <button
                            ...
                            className={`rounded-md px-4 py-2 text-white font-medium w-full mt-5 ${formIsValid
